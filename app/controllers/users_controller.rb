class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:is_provider, :username, :name, :email, :full_street_address, :phone, :description, :homepage, :photo, :registration, :password, :password_confirmation, :add_number, :add_name, :add_type, :your_city, :postal)
  end
