class UsersController < ApplicationController
 ...
 def show
   @user = load_user
   if current_user
     @current_address = [current_user.add_number,
                         current_user.add_name,
                         current_user.add_type,
                         current_user.your_city,
                         current_user.postal].join("+")

     @address         =  [@user.add_number,
                          @user.add_name,
                          @user.add_type,
                          @user.your_city,
                          @user.postal].join("+")
