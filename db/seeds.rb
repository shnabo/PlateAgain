...
User.create(is_provider: false,
            ...
            password: 'password',
            password_confirmation: 'password',
            full_street_address: '191 New Toronto St., Toronto, ON M8V2E7',
            phone: '416-203-0050',
...
User.create(is_provider: false,
            ...
            password: 'password',
            password_confirmation: 'password',
            full_street_address: '20 Gerrard St E, Toronto, ON M5B2P3',
            phone: '416-598-4898',
...
User.create(is_provider: true,
            ...
            password: 'password',
            password_confirmation: 'password',
            full_street_address: '141 St George St., Toronto, ON M5R2L8',
            phone: '416-967-7245',
...
User.create(is_provider: true,
            ...
            password: 'password',
            password_confirmation: 'password',
            full_street_address: '222 Bremner blvd, Toronto, ON M5V3L9',
            phone: '416-585-8000',
...
User.create(is_provider: true,
            ...
            password: 'password',
            password_confirmation: 'password',
            full_street_address: '99 Blue Jays Way, Toronto, ON M5V9G9',
            phone: '416-348-0099',
